							...
							<form method="post" class="user"
								...
								<div class="form-group row">
									<div class="col-sm-12 mb-3 mb-sm-0">
										<input name="usuario.nome" value="${usuario.nome}" minlength="4" maxlength="20" type="text"
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
									<input name="confirmaSenha" value="${confirmaSenha}" minlength="6" maxlength="20" type="password" class="form-control form-control-user"
