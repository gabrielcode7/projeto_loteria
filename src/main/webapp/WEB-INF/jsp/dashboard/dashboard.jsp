	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="<c:url value="home"/>"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
			</li>
			<!-- Divider -->
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="<c:url value="apostas"/>">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Relatorio Resumo de
							Apostas</h1>
